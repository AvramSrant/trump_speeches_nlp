...
urls=['https://www.theguardian.com/us-news/live/2019/jun/28/kamala-harris-democratic-debate-2020-candidates-live-donald-trump-putin',
      ...
      'https://www.theguardian.com/world/2019/jun/28/russia-first-batch-of-trapped-whales-released',
      ...
      'https://www.theguardian.com/commentisfree/2019/jun/27/who-won-second-democratic-debate',
      'https://www.theguardian.com/commentisfree/2019/jun/28/putin-liberal-values-eu-blame-rightwing-demagogues',
      'https://www.theguardian.com/commentisfree/2019/jun/27/supreme-court-gerrymandering-dissent-elena-kagan',
      ...
      'https://www.theguardian.com/football/2019/jun/27/phil-neville-hails-bad-ass-england-players',
      'https://www.theguardian.com/music/2019/jun/28/how-to-become-liam-gallagher',
      'https://www.theguardian.com/tv-and-radio/2019/jun/28/the-loudest-voice-russell-crowe-roger-ailes',
      'https://www.theguardian.com/world/2019/jun/28/g20-world-leaders-urge-trump-and-xi-to-reach-a-trade-deal-or-risk-global-economy',
      'https://www.theguardian.com/business/2019/jun/27/seven-investors-apply-to-put-gavin-woodhouse-firms-into-administration',
      'https://www.theguardian.com/business/2019/jun/28/lego-consortium-buys-merlin-entertainments-theme-parks-for-59bn',
      ...
      'https://www.theguardian.com/money/2019/jun/28/mobile-phone-switch-network-text-pac-code',
      'https://www.theguardian.com/technology/2019/jun/27/jony-ive-apple-designer-leaves-imac-iphone',
      'https://www.theguardian.com/business/2019/jun/28/airlines-refuse-to-scrap-no-show-clauses-for-passengers',
      'https://www.theguardian.com/uk-news/2019/jun/28/gambling-addicts-parents-launch-action-to-hold-government-liable-for-his-death']
...
articles_words_with_pos={key:identify_part_of_speech(value) for key,value in no_pn__no_dots_dict.items()}
...
articles_lemmatized={article:lemmatize(list_of_tuples_of_tuples) for article,list_of_tuples_of_tuples in articles_words_with_pos.items()}
        
# Putting the words back in the original order after lemmatization
# sorting lemmatized words by their position in the text
articles_lemmatized_sorted={art_lem:sorted(list_of_tuples,key=lambda tup:tup[1]) for art_lem,list_of_tuples in articles_lemmatized.items()}
